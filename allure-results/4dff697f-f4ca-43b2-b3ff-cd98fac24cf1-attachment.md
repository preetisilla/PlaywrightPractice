...
Call log:
  - waiting for locator('iframe#pact1').first().contentFrame().locator('#inp_val')
...
```ts
  ...
  6  | 
  7  |         const frame1 = page.frameLocator('iframe#pact1').first();
  8  |         const frame2 = frame1.frameLocator('iframe#pact2');
  9  |         const frame3 = frame2.frameLocator('iframe#pact3');
  10 | 
