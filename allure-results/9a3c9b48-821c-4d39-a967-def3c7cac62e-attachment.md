        ...
        - generic [ref=e243]:
          ...
          - generic [ref=e270]:
            ...
            - generic [ref=e276]:
              - generic [ref=e277]:
                - generic [ref=e278]:
                  - generic [ref=e279]: JUnit
                  - button "Remove JUnit" [ref=e280] [cursor=pointer]:
                    - img [ref=e281]
                - generic [ref=e283]:
                  - generic [ref=e284]: Pytest
                  - button "Remove Pytest" [ref=e285] [cursor=pointer]:
                    - img [ref=e286]
              ...
              - generic [ref=e313]:
                - generic [ref=e314]:
                  ...
                  - button "Remove api-testing" [ref=e316] [cursor=pointer]:
                    - img [ref=e317]
                - generic [ref=e319]:
                  - generic [ref=e320]: performance
                  - button "Remove performance" [ref=e321] [cursor=pointer]:
                    - img [ref=e322]
          ...
          - generic [ref=e383]: "{ \"rs-single\": \"Cypress\", \"rs-multi\": [ \"JUnit\", \"Pytest\" ], \"rs-creatable\": [ \"api-testing\", \"performance\" ], \"rs-grouped\": null, \"rs-async\": null }"
...
```ts
  ...
  9  |         await page.getByText('Cypress',{exact:true}).click();
  10 | 
  11 |         await page.locator('#rs-multi.tta-rs').click();
  ...
  15 | 
  16 |         await page.locator('#rs-creatable.tta-rs').click();
  17 |         await page.getByText('api-testing',{exact:true}).click();
  18 |         await page.getByText('performance',{exact:true}).click();
  19 |         await page.keyboard.press('Escape');
  20 | 
  21 |         await page.locator('#rs-async').click();
> 22 |         await page.locator('#rs-async').fill('Pune');
     |                                         ^ Error: locator.fill: Error: Element is not an <input>, <textarea>, <select> or [contenteditable] and does not have a role allowing [aria-readonly]
  23 |         await page.getByText('Pune',{exact:true}).click();
  24 |         
  25 |         
