...
- Name: 06_WebTables\Tasks\Task1.spec.ts >> QA Profile Form >> Complete the QA profile 
- Location: tests\06_WebTables\Tasks\Task1.spec.ts:4:5
            ...
            - generic [ref=e278]:
              ...
              - radiogroup "Profession" [ref=e280]:
                ...
                - generic [ref=e283] [cursor=pointer]:
                  - radio "Automation Tester" [ref=e284]
            ...
            - generic [ref=e292]:
              ...
              - generic "Automation tools" [ref=e294]:
                ...
                - generic [ref=e297] [cursor=pointer]:
                  - checkbox "Protractor" [ref=e298]
                  - text: Protractor
                - generic [ref=e299] [cursor=pointer]:
                  - checkbox "Selenium Webdriver" [ref=e300]
...
```ts
  ...
  2  | 
  3  | test.describe('QA Profile Form', () => {
  4  |     test('Complete the QA profile ', async ({ page }) => {
  5  |         await page.goto('https://app.thetestingacademy.com/playwright/tables/practice');
  6  |         
  7  |         await page.getByRole('textbox',{name:'first Name'}).fill('Preeti');
  8  |         await page.getByRole('textbox',{name:'last Name'}).fill('Silla');
  9  | 
  10 |         await page.getByTestId('gender-male').check();
  11 | 
  12 |         await page.selectOption('select[name="yearsExperience"]','3');
  13 | 
> 14 |         await page.getByRole('textbox',{name:'date'}).fill('07-05-2026');
     |                                                       ^ Error: locator.fill: Error: Malformed value
  15 | 
  16 |         await page.getByTestId('profession-automation').check();
  17 | 
  18 |         await page.getByTestId('tool-selenium').check();
  19 | 
  20 |         await page.getByTestId('continent-asia').check();
  21 | 
  22 |         //await page.getByRole('checkbox',{data-testid:'tool-selenium'}).check();
  23 |         //await page.locator('//input[@value="Automation Tester"]').check();
  24 |         //await page.locator('//input[@value="Selenium Webdriver"]').check();
  25 | 
  26 |         //await page.locator('//input[@value="Asia"]').check();
  27 | 
