...
```ts
  ...
  6  |         
> 7  |         await page.getByRole('textbox',{name:'firstName'}).fill('John');
     |                                                            ^ Error: locator.fill: Test timeout of 30000ms exceeded.
  8  |         await page.getByRole('textbox',{name:'lastName'}).fill('Doe');
  9  | 
  10 |         await page.getByRole('radio',{name:'gender'}).check();
  11 | 
  12 |         await page.selectOption('select[name="yearsExperience"]','3');
  13 | 
  14 |         await page.getByRole('textbox',{name:'date'}).fill('07-05-2026');
  15 | 
  16 |         //await page.getByRole('radio',{data-testid:'profession-automation'}).check();
  17 | 
  18 |         //await page.getByRole('checkbox',{data-testid:'tool-selenium'}).check();
  19 |         await page.locator('//input[@value="Automation Tester"]').check();
  20 |         await page.locator('//input[@value="Selenium Webdriver"]').check();
  21 | 
  22 |         await page.locator('//input[@value="Asia"]').check();
  23 | 
