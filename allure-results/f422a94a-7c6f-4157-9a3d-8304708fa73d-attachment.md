...
```
Error: locator.click: Error: strict mode violation: getByText('Taxi') resolved to 7 elements:
    1) <p class="help">…</p> aka getByText('Hover Add-ons to reveal Taxi')
    2) <a href="#" role="menuitem" class="submenu-item" data-testid="test-id-Taxi">…</a> aka getByTestId('test-id-Taxi')
    3) <span class="tta-mark-chip is-test">…</span> aka getByText('children=test-id-Taxi · test-')
    4) <code>data-testid="test-id-Taxi"</code> aka getByText('data-testid="test-id-Taxi"')
    5) <code>getByTestId('test-id-Taxi').click()</code> aka getByText('getByTestId(\'test-id-Taxi\').click()', { exact: true })
    6) <span class="token-comment">// 1) hover Add-ons → click Taxi</span> aka getByText('// 1) hover Add-ons → click')
    7) <span class="token-string">'test-id-Taxi'</span> aka getByText('\'test-id-Taxi\'', { exact: true })

Call log:
  - waiting for getByText('Taxi')
      ...
      - generic [ref=e239]:
        - article [ref=e241]:
          ...
          - navigation "Travel main" [ref=e245]:
            ...
            - generic [ref=e248]:
              - text: Add-ons
              - menu "Add-ons submenu" [ref=e249]:
                - menuitem "🚖 Taxi" [ref=e250] [cursor=pointer]:
                  - generic [ref=e251]: 🚖
                  - text: Taxi
                - menuitem "🏨 Hotel" [ref=e252] [cursor=pointer]:
                  - generic [ref=e253]: 🏨
                  - text: Hotel
                - menuitem "🛡️ Insurance" [ref=e254] [cursor=pointer]:
                  - generic [ref=e255]: 🛡️
                  - text: Insurance
                - menuitem "🍽️ Meal" [ref=e256] [cursor=pointer]:
                  - generic [ref=e257]: 🍽️
                  - text: Meal
                - menuitem "📶 Wi-Fi" [ref=e258] [cursor=pointer]:
                  - generic [ref=e259]: 📶
                  - text: Wi-Fi
                - menuitem "🎟️ Activities" [ref=e260] [cursor=pointer]:
                  - generic [ref=e261]: 🎟️
                  - text: Activities
            - generic [ref=e262]: Holidays
            - generic [ref=e263]: Account › ›
          - generic [ref=e264]:
            - generic [ref=e265]:
              - generic [ref=e266]: data-testid
              - text: =nav-add-ons · nav-account
            - generic [ref=e267]:
              - generic [ref=e268]: children
              - text: =test-id-Taxi · test-id-Hotel · test-id-Insurance · test-id-Meal · test-id-Wifi · test-id-Activities
            - generic [ref=e269]:
              - generic [ref=e270]: nested
              - text: =test-id-Upcoming · test-id-Past · test-id-Cancelled (Account → Bookings)
          - generic [ref=e271]: No item clicked yet.
        - complementary [ref=e272]:
          - generic [ref=e273]:
            - heading "What students should practise" [level=3] [ref=e274]
            - list [ref=e275]:
              - listitem [ref=e276]:
                - text: Hover
                - code [ref=e277]: data-testid="nav-add-ons"
                - text: ", then click"
                - code [ref=e278]: data-testid="test-id-Taxi"
                - text: .
              - listitem [ref=e279]:
                - text: Use
                - code [ref=e280]: "getByText('Add-ons', { exact: true }).hover()"
                - text: +
                - code [ref=e281]: getByTestId('test-id-Taxi').click()
                - text: .
              - listitem [ref=e282]:
                - text: Hover
                - emphasis [ref=e283]: Account
                - text: ", hover"
                - emphasis [ref=e284]: Bookings
                - text: (chevron item), click
                - emphasis [ref=e285]: Upcoming
                - text: .
              - listitem [ref=e286]:
                - text: Assert the submenu becomes visible only after hover (
                - code [ref=e287]: toBeVisible()
                - text: on hover,
                - code [ref=e288]: toBeHidden()
                - text: after mouse-out).
              - listitem [ref=e289]:
                - text: Read every Add-ons child text via
                - code [ref=e290]: locator('.submenu .submenu-item').allInnerTexts()
                - text: after hover.
          - group [ref=e291]:
            - generic "Playwright solution Single hover, then nested hover. Show solution" [ref=e292] [cursor=pointer]:
              - img [ref=e294]
              - generic [ref=e296]:
                - strong [ref=e297]: Playwright solution
                - generic [ref=e298]: Single hover, then nested hover.
              - generic [ref=e299]: Show solution
```
...
> 9  |         await page.getByText('Taxi').click();
     |                                      ^ Error: locator.click: Error: strict mode violation: getByText('Taxi') resolved to 7 elements:
